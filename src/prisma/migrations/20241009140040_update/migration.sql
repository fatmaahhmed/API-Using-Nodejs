...
INSERT INTO "new_product" ("brand_id", "category_id", "createdAt", "description", "discount_price", "is_best_seller", "is_on_sale", "price", "product_id", "product_name", "quantity", "rating", "reviews_count", "sale_end_date", "sale_start_date", "slug", "updatedAt", "user_id") SELECT "brand_id", "category_id", "createdAt", "description", "discount_price", "is_best_seller", "is_on_sale", "price", "product_id", "product_name", "quantity", "rating", "reviews_count", "sale_end_date", "sale_start_date", "slug", "updatedAt", "user_id" FROM "product";
DROP TABLE "product";
