...
INSERT INTO "new_cart" ("cartItem_id", "cart_id", "createdAt", "status", "total_with_copon", "updatedAt", "user_id") SELECT "cartItem_id", "cart_id", "createdAt", "status", "total_with_copon", "updatedAt", "user_id" FROM "cart";
DROP TABLE "cart";
