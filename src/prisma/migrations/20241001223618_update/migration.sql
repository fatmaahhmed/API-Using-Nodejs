...
INSERT INTO "new_product" ("category_id", "description", "discount_price", "is_best_seller", "is_on_sale", "name", "price", "product_id", "quantity", "rating", "reviews_count", "sale_end_date", "sale_start_date", "subcategory_id", "user_id") SELECT "category_id", "description", "discount_price", "is_best_seller", "is_on_sale", "name", "price", "product_id", "quantity", "rating", "reviews_count", "sale_end_date", "sale_start_date", "subcategory_id", "user_id" FROM "product";
DROP TABLE "product";
